...
public class PoApprovalActionBean extends BaseMaintenanceActionBean<Po> {
	
	private String LIST_PAGE = "/WEB-INF/pages/poApproval/poApprovalList.jsp";
	private String DETAIL_PAGE = "/WEB-INF/pages/poApproval/poApprovalDetail.jsp";
	...
	public String getPageTitle() {
		return getLocalizeableMessage("nav."+SystemConstant.MenuCode.PO_APPROVAL);
	}
