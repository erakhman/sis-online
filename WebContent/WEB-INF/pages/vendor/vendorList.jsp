		    	...
		    	<table cellspacing="0" cellpadding="0" border="0">
					<tr>
		                ...
		                <td nowrap="nowrap"> 	
		              	...
		              	<td nowrap="nowrap"> 	
		                	<b><fmt:message key="label.vendorName"/></b> 
		               		<s:text name="model.vendorName"/>
		              	</td>
    	...
    	<td height="100%" valign="top">
			<table cellspacing="0" cellpadding="0" id="tableList" width="100%">
	        	<thead>
	            	<tr>
	            		<td class="hidden"></td>
	            		<td class="listHeader"><fmt:message key="label.vendorCode"/></td>  
	                    <td class="listHeader"><fmt:message key="label.vendorName"/></td>  
	                    <td class="listHeader"><fmt:message key="label.address"/></td>
	                    <td class="listHeader"><fmt:message key="label.city"/></td>
	                    <td class="listHeader"><fmt:message key="label.province"/></td>
	                    <td class="listHeader"><fmt:message key="label.postalCode"/></td>
	                    <td class="listHeader"><fmt:message key="label.country"/></td>  
	             	</tr>
	        	</thead>
				<tbody></tbody>	
         	</table>
...
$(document).ready(function(){
	showList(1);
	$('#'+'<%=SystemConstant.MenuCode.VENDOR%>').addClass('tabActive');
});
...
function populateTable(data){
	...
	$.each(data,function(i){
		tBody += 
   			'<tr>'+
   				'<td class="hidden">'+this.pkVendor+'</td>'+
   				'<td class="listItem">'+this.vendorCode+'</td>'+
   				'<td class="listItem">'+this.vendorName+'</td>'+
   				'<td class="listItem">'+this.address+'</td>'+
   				'<td class="listItem">'+this.city+'</td>'+
   				'<td class="listItem">'+this.province+'</td>'+
   				'<td class="listItem">'+this.postalCode+'</td>'+
   				'<td class="listItem">'+this.country+'</td>'+
   			'</tr>';
	});
	return tBody;
}
