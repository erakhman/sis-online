    	...
    	<td height="100%" valign="top">
			<table cellspacing="0" cellpadding="0" id="tableList" width="100%">
	        	<thead>
	            	<tr>
	            		<td class="hidden"></td>
	            		<td class="listHeader">Kode Rak</td>
	            		<td class="listHeader">Nama Rak</td> 
	             	</tr>
	        	</thead>
				<tbody></tbody>	
         	</table>
...
$(document).ready(function(){
	showList(1);
	$('#'+'<%=SystemConstant.MenuCode.BOOK_SHELF%>').addClass('tabActive');
});
	...
	$.each(data,function(i){
		tBody += 
   			'<tr>'+
   				...
   				'<td class="listItem">'+this.shelfCode+'</td>'+
   				'<td class="listItem">'+this.shelfName+'</td>'+
   			'</tr>';
	});
	return tBody;
}
