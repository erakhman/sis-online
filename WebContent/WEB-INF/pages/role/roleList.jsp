		    	...
		    	<table cellspacing="0" cellpadding="0" border="0">
					<tr>
		                ...
		                <td nowrap="nowrap"> 	
		              	...
		              	<td nowrap="nowrap"> 	
		                	<b><fmt:message key="label.roleName"/></b> 
    	...
    	<td height="100%" valign="top">
			<table cellspacing="0" cellpadding="0" id="tableList" width="100%">
	        	<thead>
	            	<tr>
	            		<td class="hidden"></td>
	            		<td class="listHeader"><fmt:message key="label.roleCode"/></td>  
	                    <td class="listHeader"><fmt:message key="label.roleName"/></td>  
	             	</tr>
	        	</thead>
				<tbody></tbody>	
         	</table>
...
$(document).ready(function(){
	showList(1);
	$('#'+'<%=SystemConstant.MenuCode.ROLE%>').addClass('tabActive');
});
...
function populateTable(data){
	...
	$.each(data,function(i){
		tBody += 
   			'<tr>'+
   				'<td class="hidden">'+this.pkRole+'</td>'+
   				'<td class="listItem">'+this.roleCode+'</td>'+
